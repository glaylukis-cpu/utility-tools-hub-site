...
HTML Editorの利用例として、Free Previewの基本ブロックで作成した架空サービス「Studio Note」の[完成サンプルと使い方](examples/studio-note/guide.html)を紹介しています。

## ファイル構成

- `index.html` — 製品概要と主要なダウンロード導線
- `download.html` — v0.11.0 Windows版のインストール案内
